...
export default async function RequestServicePage({ searchParams }: { searchParams: Promise<{ sector?: string; servicio?: string }> }) {
  ...
  return (
    <main className="service-request-surface relative min-h-screen px-5 pb-20 pt-44 md:pt-48 text-[#F8F7F4] md:px-8"><Navbar /><div className="form-separator" aria-hidden="true" />
      <div className="mx-auto grid max-w-[1280px] gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
        <div>
          ...
          <p className="mt-7 max-w-md text-base leading-7 text-white/80">Prepararemos una propuesta adaptada a las necesidades de tu empresa y evento.</p>
        </div>
