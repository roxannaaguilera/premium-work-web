...
export default function CookiesPolicy() {
  return <LegalPage title="Política de cookies">
    ...
    <p>El almacenamiento para recordar una elección solicitada no se utiliza para perfilar visitantes. El aviso aparece al abrir o recargar la web y permanece hasta una elección expresa. Si desmarcas «Guardar mi elección», se elimina el valor guardado. Los formularios no guardan el CV ni sus campos en localStorage.</p>
